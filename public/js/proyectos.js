...
const projects = [
  ...
  //constante de todos mis svg
  const technologyIcons = [
    {
      name: "HTML",
      icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 452 520" width="30" height="30">
    ...
    {
      name: "JavaScript",
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 1052 1052">
    ...
    },
    {
      ...
      icon: `<svg
          ...
          width="30"
          height="30"
          class="hover-illuminate-react hover-illuminate"
    ...
    },
    {
        name: "Tailwind",
        icon: `<svg
                class="hover-illuminate hover-illuminate-tailwind"
                viewBox="0 0 256 154"
                width="30"
                height="30"
                xmlns="http://www.w3.org/2000/svg"
    ...
    },
    {
        ...
        icon: `              <svg
                  ...
                  width="30"
                  viewBox="0 -1 100 50"
                  class="hover-illuminate-php hover-illuminate"
                >
                  <path
                    fill="#fff"
    ...
    },
    {
        ...
        icon: `              </svg>
                ...
                preserveAspectRatio="xMidYMid"
                viewBox="0 0 256 252"
                class="hover-illuminate-mysql hover-illuminate"
              >
                <path
 ...
 // Función para buscar el icono de una tecnología específica
function getTechnologyIcon(name) {
    const tech = technologyIcons.find(icon => icon.name === name);
    return tech ? tech.icon : ""; // Retorna el SVG del icono o una cadena vacía si no encuentra el icono
  }
  
  // Selecciona el contenedor donde se van a insertar las tarjetas de proyectos
  const projectContainer = document.getElementById("projectContainer");
  
  // Genera cada tarjeta de proyecto
  projects.forEach((project) => {
    const projectCard = `
      <article" target="_blank" class="flex flex-col overflow-hidden rounded-lg shadow-[rgba(255,255,255,0.15)_0px_0px_15px,rgba(255,255,255,0.2)_0px_0px_30px]">
        
          <div class="overflow-hidden">
            <img src="${project.image}" alt="${project.title}" class="w-full h-[244px] transition-transform duration-300 hover:scale-105">
          </div>
          <div class="bg-black bg-opacity-75 text-white p-4 w-full">
            <h3 class="font-extrabold tracking-wider underline decoration-wavy text-lg titulo_proyectos">${project.title}</h3>
            <p class="text-sm tracking-wider mb-4">${project.description}</p>
  
            <!-- Enlaces con iconos -->
            <div class="mb-4">
              <h3 class="text-white text-xl mb-2 font-bold titulo_proyectos">Enlaces:</h3>
              <div class="flex space-x-5">
                <a href="${project.githubLink}" class="text-white text-2xl" target="_blank" aria-label="Código fuente en GitHub">
                  <!-- GitHub Icon SVG -->
                  <svg
                  viewBox="0 0 256 250"
                  width="30"
                ...
                <a href="${project.liveLink}" class="text-white text-2xl" target="_blank" aria-label="Visitar el sitio del proyecto">
            ...
            <div>
              <h3 class="text-white text-xl font-bold mb-2">Tecnologías utilizadas:</h3>
              <div class="flex space-x-4 mt-2">
                ${project.technologies.map(techName => getTechnologyIcon(techName)).join("")}
              </div>
            </div>
          </div>
